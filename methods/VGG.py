...
def _make_layers(vgg_cfg: List[Union[str, int]], batch_norm: bool = False, in_channels=3) -> nn.Sequential:
...
class VGG(nn.Module):
    def __init__(self, vgg_cfg: List[Union[str, int]], batch_norm: bool = False, num_classes: int = 1000, img_channels:int =3) -> None:
        super(VGG, self).__init__()
        self.features = _make_layers(vgg_cfg, batch_norm, in_channels=img_channels)
